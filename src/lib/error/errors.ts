...
export class DuplicateRequestError extends CustomError {
  constructor(message: string = "Duplicate request. Try again.", data?: ErrorData, code?: number | string) {
...
export class ServerDown extends CustomError {
  constructor(message: string = "We are currently undergoing maintenance, please check back later.", data?: ErrorData) {
...
export class BadGatewayError extends CustomError {
  constructor(message: string = "Something went wrong, try again later.", data?: ErrorData, code?: number | string) {
